...
from ._types import BASE_SCHEMA, DEPENDENCIES
from ._utils import pagination_factory

NOT_FOUND = HTTPException(404, 'Item not found')


class CRUDRouterBase(Generic[BASE_SCHEMA], APIRouter):
    schema: Type[BASE_SCHEMA]
    create_schema: Type[BASE_SCHEMA]
    update_schema: Type[BASE_SCHEMA]
    _base_path: str = '/'

    def __init__(
        self,
        schema: Type[BASE_SCHEMA],
        create_schema: Type[BASE_SCHEMA] = None,
        update_schema: Type[BASE_SCHEMA] = None,
